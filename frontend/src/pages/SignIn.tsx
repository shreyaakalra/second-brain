    ...
    <div className="flex h-screen bg-white overflow-hidden">
      ...
      >
        ...
        <div className="absolute inset-0 bg-black/20 flex flex-col justify-end p-12">
          ...
          >
            "Everything I save,<br />right when I need it."
          </motion.p>
          <motion.p
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
      ...
      <div className="w-full md:w-1/2 flex flex-col justify-center px-8 sm:px-16 relative z-10">
        ...
        >
          ...
          <p className="mt-3 text-sm text-neutral-500 font-medium">
            No account yet?{" "}
            <Link to="/sign-up" className="text-black font-bold underline underline-offset-2 hover:text-yellow-600 transition-colors">
              Create one free
            </Link>
          </p>
        </motion.div>
